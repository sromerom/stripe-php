...
class ApplicationFeeService extends \Stripe\Service\AbstractService
{
     ...
     * @return \Stripe\Collection
     */
    public function allRefunds($id, $params = null, $opts = null)
    {
        return $this->request('get', $this->buildPath('/v1/application_fees/%s/refunds', $id), $params, $opts);
    }
     ...
     * @return FeeRefund
     */
    public function createRefund($id, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/v1/application_fees/%s/refunds', $id), $params, $opts);
    }
