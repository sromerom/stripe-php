...
class SubscriptionItemService extends \Stripe\Service\AbstractService
{
     ...
     * @return \Stripe\Collection
     */
    public function allUsageRecordSummaries($id, $params = null, $opts = null)
    {
        return $this->request('get', $this->buildPath('/v1/subscription_items/%s/usage_record_summaries', $id), $params, $opts);
    }
     ...
     * @return UsageRecord
     */
    public function createUsageRecord($id, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/v1/subscription_items/%s/usage_records', $id), $params, $opts);
    }
     ...
     * @return SubscriptionItem
     */
    public function usageRecordSummaries($id, $params = null, $opts = null)
    {
        return $this->request('get', $this->buildPath('/v1/subscription_items/%s/usage_record_summaries', $id), $params, $opts);
    }
}
