...
class TransferService extends \Stripe\Service\AbstractService
{
     ...
     * @return \Stripe\Collection
     */
    public function allReversals($id, $params = null, $opts = null)
    {
        return $this->request('get', $this->buildPath('/v1/transfers/%s/reversals', $id), $params, $opts);
    }
     ...
     */
    public function createReversal($id, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/v1/transfers/%s/reversals', $id), $params, $opts);
    }
